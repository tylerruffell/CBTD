...
namespace CBTDWeb.Pages.Manufacturers
{
    public class IndexModel : PageModel
    {
        ...
        public List<Manufacturer> objManufacturerList;  //our UI front end will support looping through and displaying Manufacturers retrieved from the database and stored in a List
